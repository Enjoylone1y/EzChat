...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, ResourcesUtils.getAttrResources(context, "SwipeBackLayout"));
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                ResourcesUtils.getStyleableArray(context, "SwipeBackLayout"), defStyle,
                ResourcesUtils.getStyleResources(context, "SwipeBackLayout"));
        int edgeSize = a.getDimensionPixelSize(
                ResourcesUtils.getStyleable(context, "SwipeBackLayout_edge_size"), -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(
                ResourcesUtils.getStyleable(context, "SwipeBackLayout_edge_flag"), 0)];
        setEdgeTrackingEnabled(mode);//默认做侧滑
        int shadowLeft = a.getResourceId(ResourcesUtils.getStyleable(context, "SwipeBackLayout_shadow_left"),
                ResourcesUtils.getDrawableResources(context, "shadow_left"));
        int shadowRight = a.getResourceId(ResourcesUtils.getStyleable(context, "SwipeBackLayout_shadow_right"),
                ResourcesUtils.getDrawableResources(context, "shadow_right"));
        int shadowBottom = a.getResourceId(ResourcesUtils.getStyleable(context, "SwipeBackLayout_shadow_bottom"),
                ResourcesUtils.getDrawableResources(context, "shadow_bottom"));
    ...
    public void setOnFinishActivityListener(FinishActivityListener listener) {
        mFinishActivityListener = listener;
    }

    public interface FinishActivityListener {
        /**
         * 侧滑关闭Activity之前可以做一些操作，例如使用startActivityForResult()启动Activity时，可以在此做setResult()操作
         */
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent >= 1 && !mActivity.isFinishing()) {
                if (mFinishActivityListener != null) {
                    mFinishActivityListener.dothingBeforeFinish();
                }
                mActivity.finish();
